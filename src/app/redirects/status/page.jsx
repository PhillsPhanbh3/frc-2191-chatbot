...
export default function NotFound() {
  ...
  useEffect(() => {
    ...
    if (count === 0) {
      window.location.href = 'https://2191chatbotstatus.statuspage.io/';
    }
    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-dark)] relative overflow-hidden">
      ...
      <div className="max-w-md mx-auto text-center px-4 relative z-10">
        ...
        >
          ...
          >
            You have been redirected to the status page! Click the button or wait for the countdown to finish!
          </motion.p>
          ...
          >
            <Link
              href="https://2191chatbotstatus.statuspage.io/"
